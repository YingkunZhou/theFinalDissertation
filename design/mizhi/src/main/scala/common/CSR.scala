...
import chisel3._
import chisel3.util.{Cat, Mux1H, PopCount}
import Util._
...
class PerfCounterIO(implicit val conf: CpuConfig) extends Bundle{
...
class CSRFileIO(implicit val conf: CpuConfig) extends Bundle {
...
class CSRFile(implicit val conf: CpuConfig) extends Module
{
