...
class FrontEndIO(implicit val conf: CpuConfig) extends Bundle
{
...
class FrontEndCpuIO(implicit val conf: CpuConfig) extends Bundle
{
...
class FrontEnd(implicit val conf: CpuConfig) extends Module {
