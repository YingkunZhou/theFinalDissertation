...
import common.{CSR, CpuConfig, DebugCPath, MemPortIo}
import rv32_3stage.ALU._
...
class CpathIo(implicit val conf: CpuConfig) extends Bundle()
{
...
class CtlPath(implicit val conf: CpuConfig) extends Module {
