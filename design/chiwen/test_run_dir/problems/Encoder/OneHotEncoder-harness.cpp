...
#endif
#include <iostream>
class OneHotEncoder_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    OneHotEncoder_api_t(VOneHotEncoder* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_0)));
        ...
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_5)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_6)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_7)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_8)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_9)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_10)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_11)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_12)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_13)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_14)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_in_15)));
        sim_data.outputs.push_back(new VerilatorCData(&(dut->io_out)));
        sim_data.signals.push_back(new VerilatorCData(&(dut->reset)));
        sim_data.signal_map["OneHotEncoder.reset"] = 0;
    }
#if VM_TRACE
...
static OneHotEncoder_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    VOneHotEncoder* top = new VOneHotEncoder;
    std::string vcdfile = "test_run_dir/problems/Encoder/OneHotEncoder.vcd";
