...
#endif
#include <iostream>
class OneHotDecoder_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    OneHotDecoder_api_t(VOneHotDecoder* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
...
static OneHotDecoder_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    VOneHotDecoder* top = new VOneHotDecoder;
    std::string vcdfile = "test_run_dir/problems/Decoder/OneHotDecoder.vcd";
